...
// _____ btn ____________________
function AddDeptButton({ onClick }) {
  const BASE = 44,
    MAX = 58,
    RADIUS = 13;
    ...
    >
      <button
        ...
        style={{
          ...
          color: "#9b59b6",
          transition:
            "width 0.14s cubic-bezier(0.34,1.56,0.64,1), height 0.14s cubic-bezier(0.34,1.56,0.64,1), border-radius 0.14s ease",
        }}
      >
          ...
          >
            <div
              style={{
                ...
                borderBottom: `6px solid var(--neu-border)`,
              }}
            />
            <div
              style={{
                ...
                border: "1px solid var(--neu-border)",
                boxShadow:
                  "4px 4px 12px var(--neu-shadow-dark), -2px -2px 6px var(--neu-shadow-light)",
                color: "var(--neu-text-primary)",
                fontSize: "0.71rem",
                fontWeight: 600,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <AddDeptButton onClick={() => { setEditTarget(null); setShowForm(true) }} />
        </div>
